...
export function ThemeToggle({ theme, systemTheme, onSetTheme }) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-40 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-lg z-50">
          <div className="py-1">
            <button
            ...
            >
              ...
              <span className="text-gray-900 dark:text-gray-100">System default</span>
              {theme === 'system' && (
                <svg className="w-4 h-4 text-yellow-500 ml-auto" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
